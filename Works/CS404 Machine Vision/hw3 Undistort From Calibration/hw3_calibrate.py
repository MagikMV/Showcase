...
#     https://medium.com/@dun.chwong/the-beginners-guide-camera-calibration-un-distortion-b93d41a4a274
...
#  Step through images in working directory to find pattern
for fname in images:
...
pickle.dump(dist_pickle, open( "./calib_params.p", "wb" ))    #  "wb" for Write Binary
